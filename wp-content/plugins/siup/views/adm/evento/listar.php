            ...
            <form id="frmevento" action="<?php echo site_url('evento/listar/'); ?>" class="horizontal-form" method="GET">
               ...
               <div class="col-md-6">
                ...
                <div class="form-actions text-right pal">
                    ...
                    <button type="button" class="btn btn-blue" onclick="ExportarEvento(this);"><i class="fa fa-sign-out"></i> <?php echo __("Exportar Evento", SIUP_LANG) ?></button>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table id="evento_tabela" class="table table-hover table-bordered table-advanced display">
                            ...
                            <tr>
								...
								<th style="width: 10%;"><?php echo __("Titulo", SIUP_LANG); ?></th>
								<th style="width: 15%;"><?php echo __("Descricao", SIUP_LANG); ?></th>
								<th style="width: 10%;"><?php echo __("Datainicio", SIUP_LANG); ?></th>
								<th style="width: 10%;"><?php echo __("Datafim", SIUP_LANG); ?></th>
        ...
        $.ajax({
            ...
            success: function(response) {
                if(response.sucesso)
                {
                    ...
                    {
                        ExportarEvento(response.dados.file, response.dados.posicao, response.dados.total);
                    }
                }
                else
                {
            ...
            error: function(XHR, textStatus, errorThrown){
                let msn = "<?php echo __("Falha na de verificação de evento");?>";
                $('#divloding').slideUp("slow");
                $('#divBarra').slideUp("slow");
                alert(msn);
            }
