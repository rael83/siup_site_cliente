		...
		<div class="panel-body pan">
			...
			<div class="form-body pal">
                    ...
                    <div class="form-group">
						<label for="titulo" class="col-md-3 control-label"><?php echo __("Título", SIUP_LANG); ?></label>
						<div class="col-md-9">
							<div class="input-icon">
							<i class="fa fa-pencil"></i>
							<input id="titulo" name="titulo" type="text" value="<?php echo $obj->FormGet('titulo'); ?>" class="form-control">
							</div>
						</div>
					</div>
					<div class="form-group">
...
<script>
    ...
    function SalvarEnquete(obj)
    {
       ...
       //var aux = $("#pergunta").val();
         var aux = tinyMCE.get('pergunta').getContent();
