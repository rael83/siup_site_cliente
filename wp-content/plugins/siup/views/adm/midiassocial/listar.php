<div class="col-lg-12">
    <div class="panel panel-blue">
        ...
        <?php echo __("Filtro de Midias Social", SIUP_LANG) ?>
            <div class="tools">
        ...
        <div id="painelmidiassocial" class="panel-body pan">
            <form id="frmmidiassocial" action="<?php echo site_url('midiassocial/listar/'); ?>" class="horizontal-form" method="GET">
                ...
                <div class="form-actions text-right pal">
                    ...
                    <button type="button" class="btn btn-blue" onclick="ExportarMidiassocial(this);"><i class="fa fa-sign-out"></i> <?php echo __("Exportar Midiassocial", SIUP_LANG) ?></button>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table id="midiassocial_tabela" class="table table-hover table-bordered table-advanced display">
                            ...
                            <tr>
								...
								<th style="width: 25%;"><?php echo __("Nome", SIUP_LANG); ?></th>
								<th style="width: 25%;"><?php echo __("Imagem", SIUP_LANG); ?></th>
								<th style="width: 10%;"><?php echo __("Icone", SIUP_LANG); ?></th>
								<th style="width: 10%;"><?php echo __("Status", SIUP_LANG); ?></th>
								<th style="width: 10%;"><?php echo __("Cadastradoem", SIUP_LANG); ?></th>
        ...
        $.ajax({
            ...
            success: function(response) {
                if(response.sucesso)
                {
                    ...
                    {
                        ExportarMidiassocial(response.dados.file, response.dados.posicao, response.dados.total);
                    }
                }
                else
                {
            ...
            error: function(XHR, textStatus, errorThrown){
                let msn = "<?php echo __("Falha na de verificação de midiassocial");?>";
                $('#divloding').slideUp("slow");
                $('#divBarra').slideUp("slow");
                alert(msn);
            }
