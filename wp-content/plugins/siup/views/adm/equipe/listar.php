...
<div class="col-lg-12">
    <div class="portlet box">
        <div class="portlet-header">
            <div class="caption"><?php echo __("Lista de Membro da Equipe") ?></div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table id="equipe_tabela" class="table table-hover table-bordered table-advanced display">
                            ...
                            <tr>
								...
								<th style="width: 12%;"><?php echo __("Foto", SIUP_LANG); ?></th>
								<th style="width: 20%;"><?php echo __("Nome", SIUP_LANG); ?></th>
								<th style="width: 20%;"><?php echo __("Cargo", SIUP_LANG); ?></th>
...
<script>
    ...
    {
        var $ = jQuery.noConflict();
        var informe = "Deseja excluir o membro da equipe "+nome+"?";
        if (confirm(informe))
        {
            ...
            columns: [
                ...
                {"data": "idequipe",
                    "render": function ( data, type, row, meta ) {
                        ...
                        var link = '<a href="'+url+'" class="btn-tab-editar" title="<?php echo __("Editar membro da equipe", SIUP_LANG);?>"><i class="fa fa-edit"></i></a>';
                        url = "Excluir(this,'"+row['idequipe']+"','"+row['nome']+"')";
                        link += '<a href="javascript:;" onclick="'+url+'" class="btn-tab-editar" title="<?php echo __("Excluir membro da equipe", SIUP_LANG);?>"><i class="ion ion-ios7-trash"></i></a>';
                        return link;
                    }
                }
            ],
