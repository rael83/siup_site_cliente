    ...
    <div class="panel panel-blue">
        ...
        <div id="painelenquete" class="panel-body pan">
            <form id="frmenquete" action="<?php echo site_url('enquete/listar/'); ?>" class="horizontal-form" method="GET">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="datainicioinicio" class="control-label"><?php echo __("Data Inicio entre", SIUP_LANG) ?></label>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="datafiminicio" class="control-label"><?php echo __("Data Fim entre", SIUP_LANG) ?></label>
                        <div class="input-group datetimepicker-default date">
                ...
                <div class="form-actions text-right pal">
                    ...
                    <button type="button" class="btn btn-blue" onclick="ExportarEnquete();"><i class="fa fa-sign-out"></i> <?php echo __("Exportar Enquete", SIUP_LANG) ?></button>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table id="enquete_tabela" class="table table-hover table-bordered table-advanced display">
                            ...
                            <tr>
								...
								<th style="width: 36%;"><?php echo __("Pergunta", SIUP_LANG); ?></th>
								<th style="width: 10%;"><?php echo __("Imagem", SIUP_LANG); ?></th>
								<th style="width: 8%;"><?php echo __("Status", SIUP_LANG); ?></th>
								<th style="width: 10%;"><?php echo __("Data Inicio", SIUP_LANG); ?></th>
								<th style="width: 10%;"><?php echo __("Data Fim", SIUP_LANG); ?></th>
            ...
            columns: [
				...
				{'data': 'imagem',
                    "render": function ( data, type, row, meta ) {
                        ...
                        if(Vazio(data))
                            ...
                            link = `<img src="${data}" alt='${data}' width:15%>`;
                        return link;
                    }
                },
				{'data': 'status'},
                ...
                {"data": "idenquete",
                    "render": function ( data, type, row, meta ) {
                        ...
                        url = "Excluir(this,'"+row['idenquete']+"','"+row['nomedoenquete']+"')";
