...
<div class="col-lg-12">
	<div class="panel panel-blue">
		<div class="panel-heading"><?php echo __("Formulário de Area", SIUP_LANG); ?></div>
			...
			<form id="frmArea" action="#" method="POST" class="form-horizontal">
				<div class="form-body pal">
					...
					<div class="form-group">
						<label for="idpai" class="col-md-3 control-label"><?php echo __("Idpai", SIUP_LANG); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-1">
							<button type="button" id="btn-icone" class="btn btn-primary" ><i class="fa fa-upload"></i> <?php echo __("Upload", SIUP_LANG); ?></button>
						</div>
					</div>
					<div class="form-group">
    ...
    $(function() {
        ...
        $('#btn-imagem').click(function(e) {
            ...
            arq_btn_imagem = wp.media.frames.file_frame = wp.media({
                ...
                button: {
                    text: '<?php echo __("Selecione o arquivo do invite", SIUP_LANG); ?>'
                },
                multiple: false
            });
