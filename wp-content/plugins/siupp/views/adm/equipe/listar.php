    ...
    <div class="panel panel-blue">
        ...
        <div id="painelequipe" class="panel-body pan">
            <form id="frmequipe" action="<?php echo site_url('equipe/listar/'); ?>" class="horizontal-form" method="GET">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="foto" class="control-label"><?php echo __("Foto", SIUP_LANG) ?></label>
                        <div class="input-icon right">
                            <input id="foto" name="foto" type="text" placeholder="" value="" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="form-actions text-right pal">
                    ...
                    <button type="button" class="btn btn-blue" onclick="ExportarEquipe();"><i class="fa fa-sign-out"></i> <?php echo __("Exportar Equipe", SIUP_LANG) ?></button>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table id="equipe_tabela" class="table table-hover table-bordered table-advanced display">
                            ...
                            <tr>
                                ...
                                <th style="width: 15%;"><?php echo __("Foto", SIUP_LANG); ?></th>
								<th style="width: 35%;"><?php echo __("Nome", SIUP_LANG); ?></th>
								<th style="width: 12%;"><?php echo __("Cargo", SIUP_LANG); ?></th>
								<th style="width: 12%;"><?php echo __("Status", SIUP_LANG); ?></th>
								<th style="width: 12%;"><?php echo __("Cadastrado em", SIUP_LANG); ?></th>
            ...
            columns: [
				...
				{'data': 'foto',
                    "render": function ( data, type, row, meta ) {
                        ...
                        if(Vazio(data))
                        {
                            let img = '<?php echo Componente::UrlImages("padrao/semfoto.png");?>';
                            link = '<img src="'+data+'" class="foto" title="<?php echo __("sem foto", SIUP_LANG);?>">';
                        }
                        else
                        {
                            link = '<img src="'+data+'" class="foto" title="<?php echo __("foto membro", SIUP_LANG);?>">';                       
                        }
                        return link;
                    }
                },
