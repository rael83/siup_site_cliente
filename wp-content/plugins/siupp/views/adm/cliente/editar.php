			...
			<form id="frmCliente" action="#" method="POST" class="form-horizontal">
				<div class="form-body pal">
					...
					<div class="form-group">
						<label for="idsiup" class="col-md-3 control-label"><?php echo __("Siup", SIUP_LANG); ?>
					...
					<div class="form-group">
						<label for="datanascimento" class="col-md-3 control-label"><?php echo __("Data Nnascimento", SIUP_LANG); ?>
						<span class="require">*</span></label>
						<div class="col-md-9">
