    ...
    <div class="panel panel-blue">
        ...
        <div id="painelcliente" class="panel-body pan">
            <form id="frmcliente" action="<?php echo site_url('cliente/listar/'); ?>" class="horizontal-form" method="GET">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="idsiup" class="control-label"><?php echo __("Siup", SIUP_LANG) ?></label>
                        <select id="idsiup" name="idsiup" class="form-control">
                            <?php echo $obj->GerarOpcoesIdsiup($obj->Get('idsiup'), __("--Todas--", SIUP_LANG)); ?>
                        </select>
                    </div>
                </div>
               <div class="col-md-6">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="datanascimentoinicio" class="control-label"><?php echo __("Nascido entre", SIUP_LANG) ?></label>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="datanascimentofim" class="control-label"><?php echo __("e", SIUP_LANG) ?></label>
                        <div class="input-group datetimepicker-default date">
                ...
                <div class="form-actions text-right pal">
                    ...
                    <button type="button" class="btn btn-blue" onclick="ExportarCliente();"><i class="fa fa-sign-out"></i> <?php echo __("Exportar Cliente", SIUP_LANG) ?></button>
                </div>
            </form>
        </div>
    </div>
