...
class Controller
{
	...
	public function CriarMenu()
	{
		...
		add_submenu_page($slugmenu, $titulo, __('Lista de area', SIUP_LANG), $acesso, 'listaareaSIUP', array($this, 'ControleArea'));
		add_submenu_page($slugmenu, $titulo, __('Nova area', SIUP_LANG), $acesso, 'editarareaSIUP', array($this, 'ControleArea'));
		...
		add_submenu_page($slugmenu, $titulo, __('Lista de evento', SIUP_LANG), $acesso, 'listaeventoSIUP', array($this, 'ControleEvento'));
		add_submenu_page($slugmenu, $titulo, __('Nova evento', SIUP_LANG), $acesso, 'editareventoSIUP', array($this, 'ControleEvento'));
		add_submenu_page($slugmenu, $titulo, __('Lista de midiassocial', SIUP_LANG), $acesso, 'listamidiassocialSIUP', array($this, 'ControleMidiassocial'));
		add_submenu_page($slugmenu, $titulo, __('Nova midiassocial', SIUP_LANG), $acesso, 'editarmidiassocialSIUP', array($this, 'ControleMidiassocial'));
		add_submenu_page($slugmenu, $titulo, __('Lista de pedido', SIUP_LANG), $acesso, 'listapedidoSIUP', array($this, 'ControlePedido'));
		add_submenu_page($slugmenu, $titulo, __('Nova pedido', SIUP_LANG), $acesso, 'editarpedidoSIUP', array($this, 'ControlePedido'));
	...
	public function Acoes()
	{
		if( is_admin() )
		{
			...
			add_action('wp_ajax_evento', array($this, 'ControleEvento'));
			add_action('wp_ajax_nopriv_evento', array($this, 'ControleEvento'));
			add_action('wp_ajax_midiassocial', array($this, 'ControleMidiassocial'));
			add_action('wp_ajax_nopriv_midiassocial', array($this, 'ControleMidiassocial'));
			add_action('wp_ajax_pedido', array($this, 'ControlePedido'));
			add_action('wp_ajax_nopriv_pedido', array($this, 'ControlePedido'));
        ...
        else
        {
			...
			WP_Route::get('/baixarevento/{file}', array($this,'ControleEvento'));
			WP_Route::get('/baixarmidiassocial/{file}', array($this,'ControleMidiassocial'));
			WP_Route::get('/baixarpedido/{file}', array($this,'ControlePedido'));
