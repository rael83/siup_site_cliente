...
if (!class_exists('Evento_model'))
{
	class Evento_model extends Meumodelo
	{
		...
		{
			return network_home_url()."/arq/evento/";
		}
		################################################################################################################
		public function CheckImagem($arquivo = false , $caminho = "", $completo = true)
		{
			try
			{
				if(empty($arquivo))
		...
		public function CheckThumbnail($arquivo = false , $caminho = "", $completo = true)
		{
			try
			{
				if(empty($arquivo))
