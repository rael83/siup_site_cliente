	...
	class Area
	{
        ...
        public function EditarArea()
        {
            ...
            else
            {
                ...
                {
                    $data['titulo'] = __("Erro");
                    $data['mensagem'] = __("Erro ao localizar esta área", SIUP_LANG);
            ...
            $data['listadeicone'] = Componente::GetListaIcone();
            $data['iconeveiws'] = empty($obj->icone)? "ion ion-happy": $obj->icone;
        ...
        public function SalvarArea()
        {
            ...
            if(empty($id))
            {
                Componente::SetErros(__("Falha ao salvar os dados da área.", SIUP_LANG));
                Componente::PrintErros();
                return;
            }
            ...
            {
                $informe['mensagem'] = __("Os dados da área foram criados com sucesso.", SIUP_LANG);
            }
            else
            {
                $informe['mensagem'] = __("Os dados da área foram salvos com sucesso.", SIUP_LANG);
            }
        ...
        public function ExcluirArea()
        {
            ...
            if(!$obj->Apagar())
            {
                Componente::SetErros(__("Não foi possível apagar os dados do área.", SIUP_LANG));
                Componente::PrintErros();
            }
            else
            {
                $informe['mensagem'] = __("Área foi excluida com sucesso.", SIUP_LANG);
                Componente::PrintDados($informe);
            }
            wp_die();
            return;
        ...
        public function ExportarArea()
        {
            ...
            if(empty($obj))
            {
                Componente::SetErros(__("classe com as áreas não foi encontradas..", SIUP_LANG));
                Componente::PrintErros();
                return;
            }
        ...
        public function ListaDeArea()
        {
            ...
            {
                Componente::SetErros(__("Não foi possível listar os dados da área.", HOST_LANG));
                Componente::PrintErros();
            }
            wp_die();
            return;
        ...
        public function ImportacaoExcelArea()
        {
            ...
            if($obj->FileExiste($arquivo))
            {
                ...
                if($limite > $limiteimportacao)
                {
                    ...
                    $dados['file'] = $file;
                    $dados['mensagem'] = __("Importação de área está sendo processada.");
                ...
                else
                {
                    ...
                    $dados['file'] = $file;
                    $dados['mensagem'] = __("Importação de área finalizada com sucesso.");
            ...
            {
                Componente::SetErros(__("Erro ao localizar o registro de importação de área.", SIUP_LANG));
                Componente::PrintDados($dados);
                return;
            }
            Componente::PrintDados($dados);
